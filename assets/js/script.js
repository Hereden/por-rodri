...
function calcularHora2(){
    ...
    let sumarsesion=60;
    if(hora===""){
        textoElemento = document.createTextNode("Hora actual: "+ hoy.getHours()+":" +hoy.getMinutes() + "  Hora en 1 hora: "+ (hoy.setMinutes(hoy.getMinutes() + sumarsesion) && hoy.getHours() +":" + hoy.getMinutes()));
    }else{
        hoy.setHours(hora.substring(0,2));
        hoy.setMinutes(hora.substring(3,6));
        textoElemento = document.createTextNode("Hora actual: "+ hoy.getHours()+":" +hoy.getMinutes() + "  Hora en 1 hora: "+ (hoy.setMinutes(hoy.getMinutes() + sumarsesion) && hoy.getHours() +":" + hoy.getMinutes()));
    ...
    nuevoElemento.appendChild(textoElemento);
    var parentElement = document.getElementById('resultadoParent2');
    var theFirstChild = parentElement.firstChild;
    parentElement.insertBefore(nuevoElemento, theFirstChild);
}